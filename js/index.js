...
function downloadPDF() {
	...
	const options = {
		margin: [10, 8, 10, 8], // márgenes iguales
		filename: 'Propuesta_IgnovaTech_BAPP.pdf',
		image: {type: 'jpeg', quality: 0.98},
		html2canvas: {
			scale: 1.5, // escala menor para contenido más grande
			useCORS: true,
			allowTaint: true,
			...
			scrollX: 0,
			scrollY: 0,
			width: 800, // ancho más pequeño para que se vea más grande
			height: document.body.scrollHeight,
			windowWidth: 2325, // mismo ancho que width
...
document.addEventListener('DOMContentLoaded', function () {
	...
	style.textContent = `
        ...
        .pdf-generation .header .container > div {
            display: block !important;
            text-align: center !important;
        }
        
        .pdf-generation .header .container > div > div {
